...
2. Amounts: hours as "hrs/wk"; HDM as "meals/wk". Do NOT use "units" for hour- or meal-based services (4 units = 1 hour; 1 unit = 1 HDM meal). ADH may be in days, transportation in trips. PERS is written as its TOTAL units with the device type ("PERS cellular renewal 13 units", "PERS landline renewal 12 units") - never "1 per month".
3. If the authorization is one time, the note must explicitly say "one time". If more than one one-time date is given, name every date.
4. CDC (consumer directed) authorizations: only the CDC hours are the service. Case management (T2022), per-diem (T1020), TV and 99509 lines are program components - never list them, never call them PC, never mention the codes. Write "CDC renewal 8.75 hrs/wk".
...
9. Laundry with no detailed notes (the SERVICES/NOTE carry no member-specific detail beyond the service and dates): rewrite the note EXACTLY as "Authorization received via UHC e-fax 617-275-4711 for laundry service, effective <start> to <end>, no detailed notes were included in the authorization, GSSC was notified for follow up with SCO United." - no amount, no units. Summary line: "Laundry service, effective <M/D/YY> to <M/D/YY> (no detailed notes, GSSC notified)."
12. One-time increase over MORE THAN ONE date: state the TOTAL hours and every date ("3 hrs on 9/3 and 3 hrs on 9/8" -> "one time increase of 6 hrs for 09/03/2026 and 09/08/2026"; summary "PC one time increase of 6 hrs, effective 9/3/26 and 9/8/26."). HDM: keep "lunch" when the note or SERVICES says lunch: "7 meals/wk (5 lunch weekday, 2 weekend)" in note AND summary. ADH: if SERVICES or the note names the day-health center, put it in the note ("with Blue Hill Adult Day Health Center") and the summary ("with Blue Hill ADH"). Always "/wk", never "/week" or "meals/week". PERS is never "per month" or "unit/month" - total units only.
11. Word order and phrasing: "PERS cellular renewal 13 units" (device BEFORE the action word, never "PERS renewal cellular"); "HDM initiate 7 meals/wk (5 weekday, 2 weekend)" (total first, split in parentheses, never "... total 7 meals/wk"); a weekday/weekend split is ONE summary line "PC 9.5 hrs/wk (5 weekday, 4.5 weekend), effective ...", never two lines. The summary must always contain at least one service line after "Auth:" - for a termination/suspension: "<ABBR> ends <M/D/YY> (<reason>)."
10. NEVER output a placeholder: no "null", "None", "N/A", "undefined", "TBD" or an empty slot. If a fact is missing, DROP THAT CLAUSE and keep the sentence grammatical: "can appeal the Plan's decision by null and contact the case manager" -> "can appeal the Plan's decision and contact the case manager"; "effective 08/12/2026 to null" -> "effective 08/12/2026"; "Appeal deadline: null." -> delete the sentence. (This IS a correction you must make even though it removes words.)
